...
//this function runs after adding the dom
  async componentDidMount() {
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=364e8e98229640c68ba584320bb61b7b&pageSize=${this.props.pageSize}`;
  ...
  handlePreviousClick = async()=> {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=364e8e98229640c68ba584320bb61b7b&page=${this.state.page-1}&pageSize=${this.props.pageSize}`;
    let data = await fetch(url)
    data = await data.json()
